"""Config flow for the Poste Italiane parcel tracker integration."""
...
class PosteItalianeConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle the UI-driven configuration flow for the Poste Italiane integration."""
    ...
    ) -> PosteItalianeOptionsFlowHandler:
        """Return the options flow handler."""
        return PosteItalianeOptionsFlowHandler()

    async def async_step_user(
        self, user_input: dict[str, Any] | None = None
    ) -> ConfigFlowResult:
        """Create the Poste Italiane hub — single instance, no input needed.
        ...
        the ``poste_italiane.track_parcel`` service or a dashboard button.
...
class PosteItalianeOptionsFlowHandler(OptionsFlow):
